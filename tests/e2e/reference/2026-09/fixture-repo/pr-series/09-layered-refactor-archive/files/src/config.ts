...
const DEFAULT_ARCHIVE_BUCKET = "reports-archive";
const DEFAULT_ARCHIVE_REGION = "us-east-1";
...
export function loadConfig(env: NodeJS.ProcessEnv): Config {
  return {
    ...
    archiveBucket: env.ARCHIVE_BUCKET?.trim() || DEFAULT_ARCHIVE_BUCKET,
    archiveRegion: env.ARCHIVE_REGION?.trim() || DEFAULT_ARCHIVE_REGION,
  };
}
