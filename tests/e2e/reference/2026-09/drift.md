...
| Category axis | **added** | six values: `🎯 Functional Correctness` (32), `🩺 Stability & Availability` (14), `🔒 Security & Privacy` (10), `🗄️ Data Integrity & Integration` (6), `🚀 Performance & Scalability` (5), `📐 Maintainability & Code Quality` (4) |
