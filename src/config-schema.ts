  ...
  properties: {
    ...
    release_notes: {
      ...
      properties: {
        auto: {
          type: "boolean",
          description: "Post release notes automatically once every check on the head commit passes, the review has finished, and no blocking finding is unresolved (default false).",
        },
      },
    },
